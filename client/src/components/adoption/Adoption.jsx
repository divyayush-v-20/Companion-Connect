...
const GiveForAdoption = () => {
  ...
  const handleImageUpload = async (e) => {
    ...
    formData.append("upload_preset", "ccupload"); // Create this unsigned upload preset in your Cloudinary dashboard
    ...
    <div className="min-h-screen flex flex-col bg-gray-100">
      ...
      <main className="flex-1 p-6">
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-md p-6 max-w-3xl mx-auto">
          <div className="mb-4">
            <label className="block text-gray-600 font-semibold mb-2">Pet&apos;s Name</label>
            <input
              type="text"
              value={name}
              onChange={(e) => setName(e.target.value)}
          ...
          <div className="mb-4">
            <label className="block text-gray-600 font-semibold mb-2">Breed</label>
            <input
              type="text"
              value={breed}
              onChange={(e) => setBreed(e.target.value)}
          ...
          <div className="mb-4">
            <label className="block text-gray-600 font-semibold mb-2">State</label>
            <select
              value={state}
              onChange={(e) => setState(e.target.value)}
              required
